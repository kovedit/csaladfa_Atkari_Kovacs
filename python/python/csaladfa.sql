...
(1, 'Potter', 'Vendela', 'Crownhill', 1848-09-04, 'jós', 'nő', 1901, 'démonmegszállás', 'Apácatorna', NULL, NULL),
(2, 'Venczel', 'Márton', 'Apácatorna', 1848-03-15, 'forradalmár', 'férfi', 1910, 'cenzúra', 'Budapest', NULL, NULL),
...
(6, 'Gáspár', 'Győző', 'Újkígyós', 1865-07-31, 'olimpikon', 'férfi', 1918, 'háború', 'Tannenberg', NULL, NULL),
...
(9, 'Muskátli', 'Terézia', 'Vésztő', 1870-12-04, 'ékszerész', 'nő', 1950, 'betegség', 'Vésztő', NULL, NULL),
(10, 'Venczel', 'Lukács', 'Sásd', 1899-01-05, 'újságíró', 'férfi', 1919, 'baleset', 'Sásd', 9, 4),
(11, 'Cirmos', 'Sándor', 'Onga', 1889-09-08, 'politikus', 'férfi', 1968, 'gyilkosság', 'Budapest', NULL, NULL),
...
(16, 'Köves', 'Kelemen', 'Letenye', 1910-04-01, 'kőműves', 'férfi', 1984, 'öngyilkosság', 'Apácatorna', NULL, NULL),
(17, 'Köves', 'István', 'Letenye', 1936-02-24, 'pilóta', 'férfi', 1979, 'baleset', 'Apácatorna', 13, 16),
(18, 'Vitéz', 'Kálmán', 'Apácatorna', 1910-06-03, 'cukrász', 'férfi', 1956, 'gyilkosság', 'Budapest', NULL, NULL),
...
(24, 'Virágkötő', 'Flóra', 'Miskolc', 1928-11-10, 'ügyvéd', 'nő', 1990, 'betegség', 'Segesvár', NULL, NULL),
